...
include .env
build:; forge build
deploy-sepolia:; forge script script/Deployfundme.s.sol:Deployfundme --rpc-url $(RPC_URL) --private-key $(NEW_KEY) --broadcast --verify --etherscan-api-key $(ETHERSCAN_KEY) -vvvv
